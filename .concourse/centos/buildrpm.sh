...
cd ${RPMBUILD_DIR}
echo rpmbuild --define "_topdir %(pwd)" --define "_builddir %{_topdir}/BUILD" --define "_rpmdir %{_topdir}/RPMS" --define "_srcrpmdir %{_topdir}/SRPMS" --define "_specdir %{_topdir}/SPECS" --define "_sourcedir  %{_topdir}/SOURCES" -ba SPECS/systemcloud.spec
